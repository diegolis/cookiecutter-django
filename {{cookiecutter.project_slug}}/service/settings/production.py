...
# STATIC
# ------------------------------------------------------------------------------
STATICFILES_STORAGE = "service.settings.production.StaticRootGoogleCloudStorage"
...
DEFAULT_FILE_STORAGE = "service.settings.production.MediaRootGoogleCloudStorage"
